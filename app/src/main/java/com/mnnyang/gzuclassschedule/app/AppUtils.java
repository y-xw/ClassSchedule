...
public class AppUtils {
    ...
    public static int getCurrentWeek(Context context) {
        ...
        Log.d(TAG, "获取了");
        //获取开始时间
//        String beginMillis = Preferences.getString(context.getString(R.string.app_preference_start_week_begin_millis), "");
//        Long beginMillis = time.getSelectedDateMillis();
        Long beginMillis = 1693785600000L;

        //获取当前时间
        long currentMillis = Calendar.getInstance().getTimeInMillis();

        //存在开始时间
        if (!TextUtils.isEmpty(String.valueOf(beginMillis))) {
            long intBeginMillis = beginMillis;
