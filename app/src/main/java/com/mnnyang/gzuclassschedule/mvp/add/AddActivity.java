...
public class AddActivity extends BaseActivity implements AddContract.View, View.OnClickListener {
    ...
    private void initView() {
        ...
        mEtlClassroom = findViewById(R.id.et_location);
    ...
    private void submit() {
        ...
        String classroom = mEtlClassroom.getText().trim();
        //group
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (obj != null) {
                ...
                courseV2.setCouLocation(classroom);
    ...
    private void addLocation(boolean closeable) {
        ...
        if (closeable) {
            ...
            if (mAncestor != null) {
                ...
                mEtlClassroom.setText(mIntentCourseV2.getCouLocation());
            } else {
                //
