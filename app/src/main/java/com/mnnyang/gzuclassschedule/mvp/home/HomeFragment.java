...
import com.mnnyang.gzuclassschedule.time.Time;
...
//        mViewDate = mRootView.findViewById(R.id.date);
...
//            }
//        });
//        mLayoutDateSelect.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.layout_share:
                Log.d(TAG, "inShowShared");
                showShareDialog();
                Log.d(TAG, "outShowShared");
                break;
...
//            case R.id.date:
//                Log.d(TAG, "点击了");
////                time.onClick(mLayoutDateSelect);
////                time.showDatePickDlg();
//                timeSet();
//                Log.d(TAG, "运行了");
//                break;
            default:
...
//        startActivity(new Intent(activity, Time.class));
//    }

    private void showTimeDialog() {
        final DialogHelper dialogHelper = new DialogHelper();
            View dialogView = View.inflate(getContext(), R.layout.date_select, null);
            dialogView.findViewById(R.id.start_week_begin_date).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "onClickShowTimeDialog");
                dialogHelper.hideCustomDialog();
                timeSet();

//                String test = String.valueOf(time.getSelectedDateMillis());
//                Log.d(TAG, "getSelectedDateMillis" + test);
            }
        });

        dialogHelper.showCustomDialog(Objects.requireNonNull(getContext()),
                dialogView, null, ScreenUtils.dp2px(350), null);
    }
    ...
    private void timeSet(){
        ...
        calendar = Calendar.getInstance();
        datePickerDialog = new DatePickerDialog(new Time(), new DatePickerDialog.OnDateSetListener() {
            @Override
